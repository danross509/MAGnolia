...
It is available in the folder pipeline_test/data/* in 3 formats:
    Paired end with filename format 'sample1_{1,2}.fastq.gz'
    Paired end with filename format 'sampleR1_R{1,2}.fastq.gz'
    Single end (unpaired) 'sample1_SE_{1,2}.fastq.gz'
