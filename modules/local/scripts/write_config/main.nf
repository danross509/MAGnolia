...
process WRITE_CONFIG {
    ...
    cd ${launchDirectory}
    write_config.py -s $short_reads_count -p $short_reads_paired -n $nanopore_barcodes_count -pb $pacbio_reads_count -c $reads_corrected -f $config_file -g $use_gpu -d $runName
